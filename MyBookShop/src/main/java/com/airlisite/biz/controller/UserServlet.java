...
import com.airlisite.biz.dao.impl.UserDaoImpl;
import com.airlisite.biz.entity.PageBean;
import com.airlisite.biz.entity.Users;
import com.airlisite.biz.shoppingcart.ShoppingCart;
import com.airlisite.util.StringUtil;
...
public class UserServlet extends HttpServlet {
	...
	protected void login(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//调用登录验证
		UserDaoImpl dao = (UserDaoImpl)WebApplicationContextUtils.getWebApplicationContext(request.getServletContext()).getBean("iUserDao");
