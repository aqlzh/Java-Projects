...
import com.airlisite.biz.dao.impl.OrderDaoImpl;
...
import com.airlisite.biz.shoppingcart.ShoppingItem;
...
public class OrderServlet extends HttpServlet {
	...
	protected void addOrder(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//调用dao的添加订单方法
		OrderDaoImpl dao = (OrderDaoImpl)WebApplicationContextUtils.getWebApplicationContext(request.getServletContext()).getBean("iOrderDao");
